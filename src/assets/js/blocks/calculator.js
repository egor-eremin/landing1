        ...
        getBuild: function(lang, idBlock) {
            ...
            if (mainBlock) {
                ...
                if (this.defaultTitles[lang]) {
                    ...
                    innerHTMLcontent += '<button class="clc-buttonsCta__btn btn btn-main" onclick="getCalculate.getData();"><span>' + this.defaultTitles[langBuild].submitBtn + '</span></button>';
                    innerHTMLcontent += '<button class="clc-buttonsCta__btn btn btn_white btn-second" onclick="getCalculate.cleanAll(\'' + langBuild + '\');">' + this.defaultTitles[langBuild].resetBtn + '</button>';
                    innerHTMLcontent += '</div>';
                    innerHTMLcontent += '</div>';
