...
function gobuild (obj, data, item, langs) {
    ...
    if (item == 'forex' || item == 'metals') {
        htmlContent += '<thead><th>' + langs.instrument + '</th><th>' + langs.bid + '</th><th>' + langs.ask + '</th><th>' + langs.step + '</th><th>' + langs.leverage + '</th><th>' + langs.opening + '<span>*</span></th><th>' + langs.closing + '<span>*</span></th><th></th></thead><tbody>';
    } else if (item == 'stocks') {
        htmlContent += '<thead><th>' + langs.instrument + '</th><th>' + langs.bid + '</th><th>' + langs.ask + '</th><th>' + langs.cur + '</th><th>' + langs.volume + '</th><th>' + langs.leverage + '</th><th>' + langs.opening + '<span>*</span></th><th>' + langs.closing + '<span>*</span></th><th></th></thead><tbody>';
    } else if (item == 'commodities' || item == 'index') {
        htmlContent += '<thead><th>' + langs.instrument + '</th><th>' + langs.bid + '</th><th>' + langs.ask + '</th><th>' + langs.volume + '</th><th>' + langs.leverage + '</th><th>' + langs.contract + '</th><th>' + langs.opening + '<span>*</span></th><th>' + langs.closing + '<span>*</span></th><th></th></thead><tbody>';
    } else {
        htmlContent += '<thead><th>' + langs.instrument + '</th><th>' + langs.bid + '</th><th>' + langs.ask + '</th><th>' + langs.volume + '</th><th>' + langs.leverage + '</th><th>' + langs.opening + '<span>*</span></th><th>' + langs.closing + '<span>*</span></th><th></th></thead><tbody>';
    }
    ...
    prevobjcot.forEach( (element) => {
        ...
        htmlContent += '<td><div class="table-btn-wrapper"><a class="btn-buy btn btn-table" href="' + __CONFIG_GLOBAL.companyData.registratepage + '">' + langs.buy + '</a><a class="btn-sell btn_white btn btn-table" href="' + __CONFIG_GLOBAL.companyData.registratepage + '">' + langs.sell + '</a></div></td>';
        htmlContent += '</tr>';
    })
